...
noble_families %>% 
  ...
  gtsave(here::here("temp", "noble_families.png"))
```

```{r}
knitr::include_graphics(here::here("temp", "noble_families.png"))
```
...
family_links %>% 
  ...
  gtsave(here::here("temp", "family_links_sample.png"))
```

```{r}
knitr::include_graphics(here::here("temp", "family_links_sample.png"))
```
